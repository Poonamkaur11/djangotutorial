...
def single_slug(request, single_slug):
	...
	if  single_slug in categories:
		matching_series = TutorialSeries.objects.filter(Tutorial_catergory__Category_slug=single_slug)
		for m in matching_series.all():
			part_one = Tutorial.objects.filter(tutorial_series__tutorial_series=m.tutorial_series).earliest(tutorial_pblished)
	...
	tutorials = [t.tutorial_slug for t in Tutorial.objrcts.all()]
